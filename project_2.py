                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-a art-pagination">
                      <!-- button -->
                      <a href="/project_1.py" class="art-link art-color-link art-w-chevron art-left-link"><span>Projet précédent</span></a>
                      <div class="art-pagination-center art-m-hidden">
                        <a class="art-link" href="/all_projects.py">Tous les projets</a>
                      </div>
                      <!-- button -->
                      <a href="#" class="art-link art-color-link art-w-chevron"><span>Projet suivant</span></a>
                    </div>
