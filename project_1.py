                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-a art-banner" style="background-image: url(img/bg.jpg)">
                      ...
                      <div class="art-banner-overlay">
                        ...
                        <div class="art-banner-title text-center">
                          <!-- title -->
                          <h1 class="mb-15">Êtes-vous prêt pour une collaboration ?</h1>
                          <!-- suptitle -->
                          <div class="art-lg-text art-code mb-25">Donnez-moi l'occasion de vous prouver mes compétences !</div>
                          <!-- button -->
                          <a href="/contact.py" class="art-btn art-btn-md"><span>Me contacter</span></a>
                        </div>
                        <!-- main title end -->
                      </div>
                      <!-- overlay end -->
                    ...
                    <div class="art-a art-pagination">
                      <!-- button -->
                      <a href="#" class="art-link art-color-link art-w-chevron art-left-link"><span>Projet précédent</span></a>
                      <div class="art-pagination-center art-m-hidden">
                        <a class="art-link" href="/all_projects.py">Tous les projets</a>
                      </div>
                      <!-- button -->
                      <a href="/project_2.py" class="art-link art-color-link art-w-chevron"><span>Projet suivant</span></a>
                    </div>
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu">
                  ...
                  <li class="menu-item menu-item-has-children current-menu-item">
                    ...
                    <ul class="sub-menu">
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="/project_2.py">Projet 2</a></li>
                      <!-- lvl 2 nav link -->
