        ...
        <div class="art-info-bar">
          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <!-- post -->
              <div class="art-sm-text">Développeur Python / Wordpress <br>iOS / Android </div>
            </div>
            <!-- info bar header end -->
              ...
              <div class="container-fluid">
                ...
                <div class="row p-60-0 p-lg-30-0 p-md-15-0">
                  ...
                  <div class="col-lg-12">
                    ...
                    <!-- banner -->
                    <div class="art-a art-banner" style="background-image: url(img/cover.jpg)">
                      <!-- banner back -->
                      ...
                      <div class="art-banner-overlay">
                        ...
                        <div class="art-banner-title">
                          <!-- title -->
                          <h1 class="mb-15">Bienvenue ! Découvrez mon <br>parcours professionnel !</h1>
                          <!-- suptitle -->
                          <div class="art-lg-text art-code mb-25">&lt;<i>code</i>&gt; Je crée <span class="txt-rotate" data-period="2000"
                              data-rotate='[ "des interfaces web.", "tout type de site web.", "des maquettes de conception.", "des outils d&apos;automatisation." , "et je développe vos <br>applications mobiles iOS/Android de A à Z."]'></span>&lt;/<i>code</i>&gt;</div>
                          <div class="art-buttons-frame">
                            <!-- button -->
                            <a href="/history.py" class="art-btn art-btn-md"><span>SAVOIR TOUT SUR MOI</span></a>
                          </div>
                        </div>
                        <!-- main title end -->
                        <!-- photo -->
                        <img src="" class="art-banner-photo" alt="">
                        <img src="img/logo_python.png" class="logo_python" alt="Programmation Python">
                      </div>
                      <!-- banner overlay end -->
                    </div>
                    <!-- banner end -->
                ...
                <div class="row p-30-0">
                  ...
                  <div class="col-md-3 col-6">
                    ...
                    <div class="art-counter-frame">
                      ...
                      <div class="art-counter-box">
                        <!-- counter number -->
                        <span class="art-counter">13</span><span class="art-counter-plus">+</span>
                      </div>
                      <!-- counter end -->
                      <!-- title -->
                  ...
                  <div class="col-lg-4 col-md-6">
                    ...
                    <div class="art-a art-service-icon-box">
                      ...
                      <div class="art-service-ib-content">
                        ...
                        <!-- button -->
                        <div class="art-buttons-frame"><a href="/contact.py" class="art-link art-color-link art-w-chevron">Passer une commande</a></div>
                      </div>
                      <!-- service content end -->
                    </div>
                    <!-- service end -->
                ...
                <div class="row p-0-0">
                    ...
                    <div class="art-a art-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <ul class="art-price-list">
                          <!-- list item -->
                          <li>Choix et achat de votre hébergement</li>
                          <!-- list item -->
                          <li>Orientation selon votre projet</li>
                          <!-- list item -->
                          <li>Outils de performances de votre site</li>
                          <!-- list item -->
                        ...
                        <!-- price list end -->
                        <!-- button -->
                        <a href="/contact.py" class="art-link art-color-link art-w-chevron">Passez votre commande</a>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-price">
                      <!-- price body -->
                      <div class="art-price-body">
                        <h5 class="mb-30">Application web</h5>
                        <!-- price cost -->
                        <div class="art-price-cost">
                          <div class="art-number">GRATUIT<sup>*</sup></div>
                        </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-price art-popular-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <!-- price cost -->
                        <div class="art-price-cost">
                          <div class="art-number"><span>/mois</span>650<span>Euro</span></div>
                        </div>
                        <!-- price cost end -->
                        <!-- price list -->
                        <ul class="art-price-list">
                          <!-- list item -->
                          <li>Gestion de boutique en ligne</li>
                          <!-- list item -->
                          <li>Chat en ligne</li>
                          <!-- list item -->
                          <li>Réseau social</li>
                          ...
                          <li>e-learning</li>
                          <!-- list item -->
                          <li class="art-empty-item">CMS</li>
                        </ul>
                        <!-- price list end -->
                        <!-- button -->
                        <a href="/contact.py" class="art-link art-color-link art-w-chevron">Passez votre commande</a>
          ...
          <div class="art-menu-bar-frame">
            ...
            <div class="art-scroll-frame">
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu">
                  <!-- menu item -->
                  <li class="menu-item current-menu-item"><a href="/index.py">Accueil</a></li>
                  <!-- menu item -->
