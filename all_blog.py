                ...
                <div class="row p-30-0">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="art-a art-blog-card">
                      <!-- post cover -->
                      <a href="/blog_1.py" class="art-port-cover">
                        <!-- img -->
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="art-a art-blog-card">
                      ...
                      <div class="art-post-description">
                        ...
                        <div class="mb-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet!</div>
                        <!-- link -->
                        <a href="/blog_1.py" class="art-link art-color-link art-w-chevron">Read more</a>
                      </div>
                      <!-- post description end -->
                    </div>
                    <!-- blog post card end -->
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-a art-pagination">
                      ...
                      <div class="art-pagination-center art-m-hidden">
                        <a class="art-active-pag"href="/all_blog.py">1</a>
                        <a href="/blog_1.py">2</a>
                        <a href="#">3</a>
                        <a href="#">...</a>
                      </div>
                      <!-- button -->
