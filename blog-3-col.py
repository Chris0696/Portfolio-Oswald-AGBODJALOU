        ...
        <div class="art-info-bar">
          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <!-- avatar end -->
              <!-- name -->
              <h5 class="art-name mb-10"><a href="/portfolio_de_oswald_agbodj.html">Oswald AGBODJALOU</a></h5>
              <!-- post -->
            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <div class="container-fluid">
                ...
                <footer>
                  ...
                  <div>AUTEUR :&#160; <a href="portfolio_de_oswald_agbodj.html" target="_blank">Oswald J~Chris</a></div>
                </footer>
                <!-- footer end -->
          ...
          <div class="art-menu-bar-frame">
            ...
            <div class="art-scroll-frame">
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu">
                  <!-- menu item -->
                  <li class="menu-item"><a href="/portfolio_de_oswald_agbodj.html">Acceuil</a></li>
                  <!-- menu item -->
